            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="mb-10 w-full px-4 lg:w-1/2">
                        ...
                        <h2 className="mb-5 max-w-md text-3xl font-bold text-dark lg:text-4xl">
                            Yuk, belajar web Sendirian!
                        </h2>
                        <p className="max-w-xl text-base font-medium text-secondary lg:text-lg">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Id temporibus maiores sequi vitae saepe iusto
                            deleniti!
                        </p>
                    </div>
                    <div className="w-full px-4 lg:w-1/2">
                        ...
                        <p className="mb-6 text-base font-medium text-secondary lg:text-lg">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Ducimus quos, hic animi quasi ipsum
                            exercitationem ipsam incidunt voluptatem.
                        </p>
                        <div className="flex items-center">
                            <a
                                href="https://www.youtube.com/@railanzalali56"
                                target="_blank"
                            ...
                            <a
                                href="https://instagram.com/railan_zll56"
                                target="_blank"
                                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                                rel="noreferrer"
                            >
                            ...
                            <a
                                href="https://linkedin.com/in/railanzalali"
                                target="_blank"
                                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                                rel="noreferrer"
                            >
